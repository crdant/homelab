...
bosh2 alias-env kubo -e $(bosh-cli int environment-state/director.yml --path /internal_ip) --ca-cert <(bosh-cli int environment-state/creds.yml --path /director_ssl/ca)
