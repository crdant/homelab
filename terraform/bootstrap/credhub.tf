...
data "template_file" "credhub_varfile" {
  ...
  vars {
    ...
    credhub-admin-client-password = "${random_pet.credhub_admin_client_password.id}"
    credhub-admin-user-password = "${random_pet.credhub_admin_user_password.id}"
    credhub-mtls-ca
    jumpbox-ssh
    uaa-encryption-password = "${random_pet.credhub_uaa_encryption.id}"
  }
}
